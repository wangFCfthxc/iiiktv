  ...
  <div class="container">
    <div class="container-fluid" id="context">
      <div class="row text-uppercase text-center">
        ...
        <div class="col-md-6">
          <div align="center">
            <img src="../img/Store2.jpg" style="width: 80%; height: 80%" /><br><br>
            <!-- Single button -->
            <div class="btn-group">
            ...
            <h3>逢甲店</h3>
            <p>營業時間 : 24H</p>
            <p>門市地址 : <a href="https://goo.gl/maps/vMWDx3SA5Up">台中市西屯路二段273-5號3樓</a></p>
            <p>訂位電話 : <a href="tel:0427051400">04-27051400</a></p>
          ...
          <div class="col-md-8">
            <div align="center">
              <div id="myCarousel2" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                  <div class="item active">
                    <img src="../img/BigRoom1.jpg" alt="逢甲店">
                  ...
                  <div class="item">
                    <img src="../img/MidRoom1.jpg" alt="逢甲店">
                    <div class="carousel-caption">
                      <h3>逢甲店</h3>
                      <p>中包廂</p>
                    </div>
                  ...
                  <div class="item">
                    <img src="../img/SmlRoom1.jpg" alt="逢甲店">
                    <div class="carousel-caption">
                      <h3>逢甲店</h3>
                      <p>小包廂</p>
                    </div>
...
<script>
    // 建立地圖物件
    var mapProp = {
      center: new google.maps.LatLng(24.175246, 120.643989),
      zoom: 19,
    ...
    var marker = new google.maps.Marker({
      position: new google.maps.LatLng(24.175246, 120.643989),
